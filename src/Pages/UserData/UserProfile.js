...
const UserProfile = () => {
    ...
    return (
        <>
            ...
            {
                usersData.map(user => <div key={user._id}>
                    <div className='md:w-3/5 sm:w-4/5 w-11/12 mx-auto'>
                        <div>
                            <h1 className='text-center text-3xl font-medium mt-5'>{user.firstName} {user.lastName}</h1>
                            <h2 className='text-center text-xl'>{user.exJobTitle}</h2>
                        </div>
                                ...
                                editPData ?
                                    <form>
                                        <ul>
                                            ...
                                            <li className='mt-4 text-lg font-medium'>
                                                ...
                                                <select id='country' class="select w-max ml-5 border border-gray-200 focus:outline-0 focus:shadow-md">
                                    ...
                                    <ul>
                                        ...
                                        <li className='mt-4 text-lg font-medium'>Phone :
                                            <span className='font-normal ml-2'>{user.phone}</span>
                                        </li>
                                        ...
                                        <li className='mt-4 text-lg font-medium'>City/State :
                                            <span className='font-normal ml-2'>{user.state}</span>
                                        </li>
                                        <li className='mt-4 text-lg font-medium'>Country :
                                            <span className='font-normal ml-2'>{user.country}</span>
                                        </li>
                                        <li className='mt-4 text-lg font-medium'>Zip code :
                                            <span className='font-normal ml-2'>{user.zip}</span>
                                        </li>
                                    </ul>
                            }
                        </div>
                                ...
                                editEduData ?
                                    ...
                                    <ul>
                                        <li className='mt-4 text-lg font-medium'>Degree :
                                            <span className='font-normal ml-2'>{user.degree}</span>
                                        </li>
                                        <li className='mt-4 text-lg font-medium'>Institution :
                                            <span className='font-normal ml-2'>{user.institution}</span>
                                        </li>
                                        <li className='mt-4 text-lg font-medium'>Subject/Group :
                                            <span className='font-normal ml-2'>{user.edugroup}</span>
                                        </li>
                                        <li className='mt-4 text-lg font-medium'>Start Date :
                                            <span className='font-normal ml-2'>{user.eduStartDate}</span>
                                        </li>
                                        {
                                            user.eduEndDate ?
                                                <li className='mt-4 text-lg font-medium'>End Date :
                                                    <span className='font-normal ml-2'>{user.eduEndDate}</span>
                                                </li>
                                                :
                                                <li className='mt-4 text-lg font-medium'>{user.eduStudying}</li>
                                        }
                                    </ul>
                            }
                        </div>
                            ...
                            {addJobExp ?
                                    ...
                                    <form>
                                        <div>
                                            ...
                                            <div className='mt-5'>
                                                ...
                                                <textarea id='responsibilities' rows="3" type="text" placeholder="Describe your responsibilities" class="textarea text-base w-full mt-2 border border-gray-200 focus:outline-0 focus:shadow-md" />
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <ul>
                                    <li className='mt-4 text-lg font-medium'>Job Title :
                                        <span className='font-normal ml-2'>{user.exJobTitle}</span>
                                    </li>
                                    <li className='mt-4 text-lg font-medium'>Company :
                                        <span className='font-normal ml-2'>{user.exCompany}</span>
                                    </li>
                                    <li className='mt-4 text-lg font-medium'>Start Date :
                                        <span className='font-normal ml-2'>{user.exStartDate}</span>
                                    </li>
                                    {
                                        user.exEndDate ?
                                            <li className='mt-4 text-lg font-medium'>End Date :
                                                <span className='font-normal ml-2'>{user.exEndDate}</span>
                                            </li>
                                            :
                                            <li className='mt-4 text-lg font-medium'>{user.exWorking}</li>
                                    }
                                    <li className='mt-4 text-lg font-medium'>Responsibilities :
                                        <p className='font-normal'>{user.exResponsibilities}</p>
                                    </li>
                                    <li className='mt-5 text-lg'>
                                        <button onClick={() => setAddJobExp(!addJobExp)} className='btn btn-link text-accent tracking-wide'>Add new experience</button>
                                    </li>
                                </ul>
                            }
                        </div>
