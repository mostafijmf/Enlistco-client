                ...
                <form onSubmit={handleJobExp}>
                    <div>
                        <div>
                            ...
                            <input id='jobTitle' ref={jobTitleRef} required type="text" placeholder="Enter your Job title" className="input h-11 text-base bg-slate-100 w-full mt-2 border border-gray-200 focus:outline-0 focus:shadow-md" />
                        </div>
                        <div className='mt-5'>
                            ...
                            <input id='companyName' ref={companyRef} required type="text" placeholder="Enter company name" className="input h-11 text-base bg-slate-100 w-full mt-2 border border-gray-200 focus:outline-0 focus:shadow-md" />
                        </div>
                        ...
                        <div className='md:mt-5 mt-3 flex items-center'>
                            <input ref={workingRef} id='checkbox' onClick={() => setCurrentWork(!currentWork)} type="checkbox" className="checkbox bg-slate-100" />
                        ...
                        <div className='mt-5'>
                            ...
                            <textarea id='responsibilities' ref={responsibilitiesRef} rows="3" type="text" placeholder="Describe your responsibilities" className="textarea text-base bg-slate-100 w-full mt-2 border border-gray-200 focus:outline-0 focus:shadow-md" />
                        </div>
                    </div>
