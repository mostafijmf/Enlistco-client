...
const PostAppSettingForm = ({ setOpenSettingForm, data }) => {
    const {
        _id,
        receiveEmail,
        skillTags,
    ...
    const handleSubmit = async (e) => {
        ...
        const tags = openTagInput ? skillTagsState : skillTags;
        const permission = false;

        await axios.put(`https://api.enlistco.co.in/update_post/${_id}?applicationOpts=true`,
            { applyType, receiveEmail, skillTags: tags, permission },
            {
                method: 'PUT',
                headers: {
            ...
            >
                ...
                <ul className='list-none mt-5'>
                    <li className='mt-2'>
                        ...
                        <label htmlFor="easyApply" className='text-base text-gray-500 font-medium cursor-pointer flex items-center gap-2 w-max ml-4 my-2'>
                            <input
                                required
                                type="radio"
                                defaultChecked={applyType === 'easyApply'}
                    ...
                    <li className='mt-8'>
                        ...
                        {skillTags.length < 0 || openTagInput ? <div className='relative'>
                            <XIcon
...
export default PostAppSettingForm;